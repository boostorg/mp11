...
BOOST_MODULE_EXPORT template<template<class...> class F, class... L> using mp_transform = typename mp_if<mp_same<mp_size<L>...>, detail::mp_transform_impl<F, L...>, detail::list_size_mismatch>::type;

#endif

#endif

BOOST_MODULE_EXPORT template<class Q, class... L> using mp_transform_q = mp_transform<Q::template fn, L...>;
...
BOOST_MODULE_EXPORT template<template<class...> class P, template<class...> class F, class... L> using mp_transform_if = typename detail::mp_transform_if_impl<P, F, L...>::type;
BOOST_MODULE_EXPORT template<class Qp, class Qf, class... L> using mp_transform_if_q = typename detail::mp_transform_if_impl<Qp::template fn, Qf::template fn, L...>::type;
...
BOOST_MODULE_EXPORT template<template<class...> class P, class... L> using mp_filter = typename detail::mp_filter_impl<P, L...>::type;
BOOST_MODULE_EXPORT template<class Q, class... L> using mp_filter_q = typename detail::mp_filter_impl<Q::template fn, L...>::type;
...
BOOST_MODULE_EXPORT template<class L, class V> using mp_fill = typename detail::mp_fill_impl<L, V>::type;

// mp_contains<L, V>
BOOST_MODULE_EXPORT template<class L, class V> using mp_contains = mp_to_bool<mp_count<L, V>>;
...
BOOST_MODULE_EXPORT template<class L, std::size_t N> using mp_repeat_c = typename detail::mp_repeat_c_impl<L, N>::type;
BOOST_MODULE_EXPORT template<class L, class N> using mp_repeat = typename detail::mp_repeat_c_impl<L, std::size_t{ N::value }>::type;
...
BOOST_MODULE_EXPORT template<template<class...> class F, class... L> using mp_product = typename detail::mp_product_impl<F, L...>::type;
BOOST_MODULE_EXPORT template<class Q, class... L> using mp_product_q = typename detail::mp_product_impl<Q::template fn, L...>::type;
...
BOOST_MODULE_EXPORT template<class L, std::size_t N> using mp_drop_c = mp_assign<L, typename detail::mp_drop_impl<mp_rename<L, mp_list>, mp_repeat_c<mp_list<void>, N>, mp_bool<N <= mp_size<L>::value>>::type>;

BOOST_MODULE_EXPORT template<class L, class N> using mp_drop = mp_drop_c<L, std::size_t{ N::value }>;
...
BOOST_MODULE_EXPORT template<class S, class F = mp_int<0>> using mp_from_sequence = typename detail::mp_from_sequence_impl<S, F>::type;

// mp_iota(_c)<N, F>
BOOST_MODULE_EXPORT template<std::size_t N, std::size_t F = 0> using mp_iota_c = mp_from_sequence<make_index_sequence<N>, mp_size_t<F>>;
BOOST_MODULE_EXPORT template<class N, class F = mp_int<0>> using mp_iota = mp_from_sequence<make_integer_sequence<typename std::remove_const<decltype(N::value)>::type, N::value>, F>;
...
BOOST_MODULE_EXPORT template<class L, std::size_t I> using mp_at_c = typename mp_if_c<(I < mp_size<L>::value), detail::mp_at_c_impl<L, I>, void>::type;

#endif

BOOST_MODULE_EXPORT template<class L, class I> using mp_at = mp_at_c<L, std::size_t{ I::value }>;
...
BOOST_MODULE_EXPORT template<class L, std::size_t N> using mp_take_c = mp_assign<L, typename detail::mp_take_c_impl<N, mp_rename<L, mp_list>>::type>;
BOOST_MODULE_EXPORT template<class L, class N> using mp_take = mp_take_c<L, std::size_t{ N::value }>;

// mp_slice(_c)<L, I, J>
BOOST_MODULE_EXPORT template<class L, std::size_t I, std::size_t J> using mp_slice_c = mp_drop_c< mp_take_c<L, J>, I >;
BOOST_MODULE_EXPORT template<class L, class I, class J> using mp_slice = mp_drop< mp_take<L, J>, I >;

// mp_back<L>
BOOST_MODULE_EXPORT template<class L> using mp_back = mp_at_c<L, mp_size<L>::value - 1>;

// mp_pop_back<L>
BOOST_MODULE_EXPORT template<class L> using mp_pop_back = mp_take_c<L, mp_size<L>::value - 1>;
...
BOOST_MODULE_EXPORT template<class L, class V, class W> using mp_replace = typename detail::mp_replace_impl<L, V, W>::type;
...
BOOST_MODULE_EXPORT template<class L, template<class...> class P, class W> using mp_replace_if = typename detail::mp_replace_if_impl<L, P, W>::type;
BOOST_MODULE_EXPORT template<class L, class Q, class W> using mp_replace_if_q = mp_replace_if<L, Q::template fn, W>;
...
BOOST_MODULE_EXPORT template<class L, class V> using mp_remove = typename detail::mp_remove_impl<L, V>::type;
...
BOOST_MODULE_EXPORT template<class L, class L2 = mp_clear<L>> using mp_flatten = mp_apply<mp_append, mp_push_front<mp_transform_q<detail::mp_flatten_impl<L2>, L>, mp_clear<L>>>;
...
BOOST_MODULE_EXPORT template<class L, template<class...> class P> using mp_partition = typename detail::mp_partition_impl<L, P>::type;
BOOST_MODULE_EXPORT template<class L, class Q> using mp_partition_q = mp_partition<L, Q::template fn>;
...
BOOST_MODULE_EXPORT template<class L, template<class...> class P> using mp_sort = typename detail::mp_sort_impl<L, P>::type;
BOOST_MODULE_EXPORT template<class L, class Q> using mp_sort_q = mp_sort<L, Q::template fn>;
...
BOOST_MODULE_EXPORT template<class L, std::size_t I, template<class...> class P> using mp_nth_element_c = typename detail::mp_nth_element_impl<L, I, P>::type;
BOOST_MODULE_EXPORT template<class L, class I, template<class...> class P> using mp_nth_element = typename detail::mp_nth_element_impl<L, std::size_t{ I::value }, P>::type;
BOOST_MODULE_EXPORT template<class L, class I, class Q> using mp_nth_element_q = mp_nth_element<L, I, Q::template fn>;
...
BOOST_MODULE_EXPORT template<class L, class V> using mp_find = typename detail::mp_find_impl<L, V>::type;
...
BOOST_MODULE_EXPORT template<class L, template<class...> class P> using mp_find_if = typename detail::mp_find_if_impl<L, P>::type;
BOOST_MODULE_EXPORT template<class L, class Q> using mp_find_if_q = mp_find_if<L, Q::template fn>;
...
BOOST_MODULE_EXPORT template<class L> using mp_reverse = typename detail::mp_reverse_impl<L>::type;
...
BOOST_MODULE_EXPORT template<class L, class V, template<class...> class F> using mp_reverse_fold = typename detail::mp_reverse_fold_impl<L, V, F>::type;
BOOST_MODULE_EXPORT template<class L, class V, class Q> using mp_reverse_fold_q = mp_reverse_fold<L, V, Q::template fn>;
...
BOOST_MODULE_EXPORT template<class L> using mp_unique = typename detail::mp_unique_impl<L>::type;
...
BOOST_MODULE_EXPORT template<class L, class Q> using mp_unique_if_q = mp_unique_if<L, Q::template fn>;

// mp_all_of<L, P>
BOOST_MODULE_EXPORT template<class L, template<class...> class P> using mp_all_of = mp_bool< mp_count_if<L, P>::value == mp_size<L>::value >;
BOOST_MODULE_EXPORT template<class L, class Q> using mp_all_of_q = mp_all_of<L, Q::template fn>;

// mp_none_of<L, P>
BOOST_MODULE_EXPORT template<class L, template<class...> class P> using mp_none_of = mp_bool< mp_count_if<L, P>::value == 0 >;
BOOST_MODULE_EXPORT template<class L, class Q> using mp_none_of_q = mp_none_of<L, Q::template fn>;

// mp_any_of<L, P>
BOOST_MODULE_EXPORT template<class L, template<class...> class P> using mp_any_of = mp_bool< mp_count_if<L, P>::value != 0 >;
BOOST_MODULE_EXPORT template<class L, class Q> using mp_any_of_q = mp_any_of<L, Q::template fn>;
...
BOOST_MODULE_EXPORT template<class L, class I, class W> using mp_replace_at = typename detail::mp_replace_at_impl<L, I, W>::type;
BOOST_MODULE_EXPORT template<class L, std::size_t I, class W> using mp_replace_at_c = typename detail::mp_replace_at_impl<L, mp_size_t<I>, W>::type;
...
BOOST_MODULE_EXPORT template<class L, class F> BOOST_MP11_CONSTEXPR F mp_for_each( F && f )
{
    return detail::mp_for_each_impl( mp_rename<L, mp_list>(), std::forward<F>(f) );
}
...
// mp_insert<L, I, T...>
BOOST_MODULE_EXPORT template<class L, class I, class... T> using mp_insert = mp_append<mp_take<L, I>, mp_push_front<mp_drop<L, I>, T...>>;

// mp_insert_c<L, I, T...>
BOOST_MODULE_EXPORT template<class L, std::size_t I, class... T> using mp_insert_c = mp_append<mp_take_c<L, I>, mp_push_front<mp_drop_c<L, I>, T...>>;

// mp_erase<L, I, J>
BOOST_MODULE_EXPORT template<class L, class I, class J> using mp_erase = mp_append<mp_take<L, I>, mp_drop<L, J>>;

// mp_erase_c<L, I, J>
BOOST_MODULE_EXPORT template<class L, std::size_t I, std::size_t J> using mp_erase_c = mp_append<mp_take_c<L, I>, mp_drop_c<L, J>>;
...
BOOST_MODULE_EXPORT template<class L, std::size_t N> using mp_rotate_left_c = detail::mp_rotate_impl<L, detail::canonical_left_rotation<mp_size<L>::value, N>>;
BOOST_MODULE_EXPORT template<class L, class N> using mp_rotate_left = mp_rotate_left_c<L, std::size_t{ N::value }>;

// mp_rotate_right(_c)<L, N>
BOOST_MODULE_EXPORT template<class L, std::size_t N> using mp_rotate_right_c = mp_rotate_left<L, detail::canonical_right_rotation<mp_size<L>::value, N>>;
BOOST_MODULE_EXPORT template<class L, class N> using mp_rotate_right = mp_rotate_right_c<L, std::size_t{ N::value }>;
...
BOOST_MODULE_EXPORT template<class L> using mp_power_set = typename detail::mp_power_set_impl<L>::type;
...
BOOST_MODULE_EXPORT template<class L, class V, template<class...> class F> using mp_partial_sum = mp_second<mp_fold_q<L, mp_list<V, mp_clear<L>>, detail::mp_partial_sum_impl_f<F>> >;
BOOST_MODULE_EXPORT template<class L, class V, class Q> using mp_partial_sum_q = mp_partial_sum<L, V, Q::template fn>;
...
BOOST_MODULE_EXPORT template<class V, template<class...> class F, template<class...> class R> using mp_iterate = typename detail::mp_iterate_impl<V, F, R, mp_valid<R, V>>::type;
...
BOOST_MODULE_EXPORT template<class V, class Qf, class Qr> using mp_iterate_q = mp_iterate<V, Qf::template fn, Qr::template fn>;
...
BOOST_MODULE_EXPORT template<class L, class Q> using mp_pairwise_fold_q = mp_eval_if<mp_empty<L>, mp_clear<L>, detail::mp_pairwise_fold_impl, L, Q>;
BOOST_MODULE_EXPORT template<class L, template<class...> class F> using mp_pairwise_fold = mp_pairwise_fold_q<L, mp_quote<F>>;
...
BOOST_MODULE_EXPORT template<class L, class N, class Q> using mp_sliding_fold_q = typename detail::mp_sliding_fold_impl<mp_bool<(mp_size<L>::value >= N::value)>, L, N, Q>::type;
BOOST_MODULE_EXPORT template<class L, class N, template<class...> class F> using mp_sliding_fold = mp_sliding_fold_q<L, N, mp_quote<F>>;
...
BOOST_MODULE_EXPORT template<class L, class S> using mp_intersperse = typename detail::mp_intersperse_impl<L, S>::type;
...
BOOST_MODULE_EXPORT template<class L, class S> using mp_split = typename detail::mp_split_impl<L, S, mp_find<L, S>>::type;
...
BOOST_MODULE_EXPORT template<class L, class S> using mp_join = mp_apply<mp_append, mp_intersperse<L, mp_list<S>>>;
