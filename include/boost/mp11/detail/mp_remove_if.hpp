...
BOOST_MP11_MODULE_EXPORT template<class L, template<class...> class P> using mp_remove_if = typename detail::mp_remove_if_impl<L, P>::type;
BOOST_MP11_MODULE_EXPORT template<class L, class Q> using mp_remove_if_q = mp_remove_if<L, Q::template fn>;
