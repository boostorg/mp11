...
BOOST_MODULE_EXPORT template<class L, template<class...> class P> using mp_copy_if = typename detail::mp_copy_if_impl<L, P>::type;
BOOST_MODULE_EXPORT template<class L, class Q> using mp_copy_if_q = mp_copy_if<L, Q::template fn>;
