...
BOOST_MODULE_EXPORT template<class S, class V> using mp_set_contains = typename detail::mp_set_contains_impl<S, V>::type;
...
BOOST_MODULE_EXPORT template<class S, class... T> using mp_set_push_back = typename detail::mp_set_push_back_impl<S, T...>::type;
...
BOOST_MODULE_EXPORT template<class S, class... T> using mp_set_push_front = typename detail::mp_set_push_front_impl<S, T...>::type;
...
BOOST_MODULE_EXPORT template<class S> using mp_is_set = typename detail::mp_is_set_impl<S>::type;
...
BOOST_MODULE_EXPORT template<class... L> using mp_set_union = typename detail::mp_set_union_impl<L...>::type;
...
BOOST_MODULE_EXPORT template<class... S> using mp_set_intersection = typename detail::mp_set_intersection_impl<S...>::type;
...
BOOST_MODULE_EXPORT template<class L, class... S> using mp_set_difference = mp_if< mp_all<mp_is_list<S>...>, mp_remove_if_q<L, detail::in_any_set<S...>> >;
